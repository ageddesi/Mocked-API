...
import transactionInfo from '../models/transaction-info.types';

const digitalCurrencyTxList = (address: string, amount: number): transactionInfo[] => {
    const ETH_TX_LIST = [];
...
export default digitalCurrencyTxList;
