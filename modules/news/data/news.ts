...
const newsData : INews[] = [
    {
        ...
        slug: slugify(`The Rise and Fall of Bitcoin Maximalism`),
        summary:
    ...
    },
    {
        ...
        slug: slugify("Crypto's Grayscale blasts SEC over ‘special harshness' toward bitcoin trading"),
    ...
    },
    {
        ...
        slug: slugify('South African Non-Profit Bitcoin Ekasi Opens Education Center'),
        category: 'Crypto',
    ...
    },
    {
        ...
        author: 'Jody Godoy',
        slug: slugify('Grayscale says U.S. SEC set bar too high for Bitcoin funds'),
        category: 'Crypto',
    ...
    },
    {
        ...
        author: 'Pooja T.',
        slug: slugify('Bitcoin vs Altcoin: Similarities and Differences Explained'),
        category: 'Crypto',
    ...
    },
    {
        ...
        author: 'Amitej Rana',
        slug: slugify('How Much Will Bitcoin be Worth in the Year 2140?'),
        category: 'Crypto',
    ...
    },
    {
        ...
        slug: slugify('Is the Bitcoin Price About to Enter its 5th Super Cycle Bull Market?'),
        category: 'Crypto',
        summary:
    ...
    },
    {
        ...
        language: 'en',
        slug: slugify('Sustainable Bitcoin Protocol Wants to Make Bitcoin a Climate-Positive Asset'),
        category: 'Crypto',
    },
    {
        ...
        language: 'en',
        slug: slugify('Bitcoin: Breaking Up Money and State'),
        category: 'Crypto',
    },
    {
        ...
        slug: slugify('Semiconductor Silicon Carbide Electronic Power Device Market Size 2022'),
        category: 'Silicone',
        summary:
    ...
    },
    {
        ...
        slug: slugify('Dental Silicone Materials market: Market Indicators Showing Positive Outlook'),
        category: 'Silicone',
        summary:
    ...
    },
    {
        ...
        slug: slugify('Silicone Rubber Tape Market Growth and Share by 2028'),
        category: 'Silicone',
        summary:
    ...
    },
    {
        ...
        slug: slugify('Reclaim Silicon Wafer Market 2022 To 2028'),
        category: 'Silicone',
        summary:
    ...
    },
    {
        ...
        slug: slugify('Global Silicone Market Size to grow USD 30.9 Billion by 2030'),
        category: 'Silicone',
        summary:
    ...
    },
    {
        ...
        slug: slugify('Silicone Putties for Any Purpose'),
        category: 'Silicone',
        summary:
    ...
    },
    {
        ...
        slug: slugify('Silicone Structural Glazing Market Expected to Reach $81.6 Billion by 2031'),
        category: 'Silicone',
        summary:
    ...
    },
    {
        ...
        slug: slugify('Four-sided Structural Silicone Glazing market: Complete Company Profiling of Dominant Players'),
        category: 'Silicone',
        summary:
    ...
    },
    {
        ...
        slug: slugify('Silicon Frontline Receives EOS/ESD Symposium Outstanding Paper Award'),
        category: 'Silicone',
        summary:
    ...
    },
    {
        ...
        language: 'en',
        slug: slugify('Effects, Opportunities, and Fears of Artificial Intelligence'),
        category: 'AI',
    },
    {
        ...
        language: 'en',
        slug: slugify('Where has AI reached at the moment'),
        category: 'AI',
    },
    {
        ...
        language: 'en',
        slug: slugify('Steve Nouri Affirms That AI & Web3 Will Enhance Decentralization'),
        category: 'AI',
    },
    {
        ...
        language: 'en',
        slug: slugify('The increasing importance of learning AI skills and the future of work'),
        category: 'AI',
    },
    {
        ...
        language: 'en',
        slug: slugify('Transparency of AI systems for Migrants'),
        category: 'AI',
    },
    {
        ...
        language: 'en',
        slug: slugify('Birmingham company acquires Boston-based, Delaware-based companies'),
        category: 'AI',
    },
    {
        ...
        language: 'en',
        slug: slugify('The Uncertainty Bias in AI and How to Tackle it'),
        category: 'AI',
    },
    {
        ...
        slug: slugify('In the future, the medicines we take may be "made by AI"'),
        category: 'AI',
        language: 'en',
    },
    {
        ...
        language: 'en',
        slug: slugify('AGI AI Pte Ltd Launches AI+Financial Concept Services'),
        category: 'AI',
    },
    {
        ...
        language: 'en',
        slug: slugify('AI Washing: Everything You Need to Know'),
        category: 'AI',
    },
    {
        ...
        language: 'en',
        slug: slugify('Is your AI up, running and relevant?'),
        category: 'AI',
    },
    {
        ...
        language: 'en',
        slug: slugify('Fossil Gen 6 smartwatches are getting Wear OS 3'),
        category: 'OS',
    },
    {
        ...
        language: 'en',
        slug: slugify('Google Pixel Watch gets three years of updates'),
        category: 'OS',
    },
    {
        ...
        language: 'en',
        slug: slugify("Samsung's Tizen OS Poised for Use on Third-Party TVs"),
        category: 'OS',
    },
    {
        ...
        language: 'en',
        slug: slugify('Wear OS System UI App Brings Latest Experiences To Pixel Watch'),
        category: 'OS',
    },
    {
        ...
        language: 'en',
        slug: slugify('Pixel Watch: Google confirms annual Wear OS updates'),
        category: 'OS',
    },
    {
        ...
        language: 'en',
        slug: slugify('Long Noncoding RNA LINC00909 Induces Epithelial-Mesenchymal Transition'),
        category: 'OS',
    },
    {
        ...
        language: 'en',
        slug: slugify('Samsung Is Bringing Tizen OS Platform To More TV Brands: What We Know'),
        category: 'OS',
    },
    {
        ...
        language: 'en',
        slug: slugify('New Wear OS version coming every year, promised update for old watches still set for 2022'),
        category: 'OS',
    },
    {
        ...
        language: 'en',
        slug: slugify('Google Wear OS Updates Are Now Rolling Out Yearly Like How Android Works'),
        category: 'OS',
    },
];
